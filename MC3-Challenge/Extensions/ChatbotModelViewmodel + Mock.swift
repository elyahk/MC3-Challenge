extension ChatbotViewModel {
    static let mock: ChatbotViewModel = ChatbotViewModel(
        currentMessage:
            Message(id: "0", contents: ["Hello"], owner: .bot, options: [
            .init(key: "1", value: "Hi")
//            ,
//            .init(key: "6", value: "Hi 2")
        ...
        database: [
            Message(id: "1", contents: ["Nice to meet you."], options: [
                .init(key: "2", value: "Nice to meet you too."),
//                .init(key: "6", value: "Hi 2")
            ]),
            Message(id: "2", contents: ["Let me tell you more about Codice Fiscale..."], options: [.init(key: "3", value: "Ok")]),
...
//          // 8.yes, 9. no
            Message(id: "8", contents: ["You need these documents: Passport, Confirmation of Study, Application for a Tax Code in Italian language"], options: [.init(key: "10", value: "Take into account.")]),
                // yes
//          // NON-EU Citizen
            Message(id: "9", contents: ["You need these documents: Passport, Confirmation of Study, Italian version of Form for Codice, Fiscale, etc."], options: [.init(key: "10", value: "Next, please!")]),
                // no
//
//           //FOR BOTH
